package org.rebate.utils.alipay.config;
...
public class AlipayConfig {
  ...
  // 合作身份者ID，以2088开头由16位纯数字组成的字符串
  public static String partner = setting.getAlipayPartner();

  // 签约卖家支付宝账号
  public static String sellerId = setting.getAlipayPartner();
  // 商户的私钥
  public static String private_key = setting.getAlipayPrivateKey();

  // 支付宝的公钥，无需修改该值
  public static String ali_public_key = setting.getAlipayPublicKey();

  // 支付宝回调接口
  public static String ali_notify_url = setting.getAlipayNotifyUrl();
