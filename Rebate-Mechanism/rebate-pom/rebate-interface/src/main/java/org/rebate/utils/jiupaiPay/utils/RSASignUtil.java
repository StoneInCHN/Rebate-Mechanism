package org.rebate.utils.jiupaiPay.utils;
...
public class RSASignUtil {
  ...
  public String sign(String indata, String encoding) throws Exception {
    ...
    service = signMap.get("service").toString();
  ...
  public static String coverMap2String(Map<String, String> data) {
    ...
    while (it.hasNext()) {
      ...
      String en = "";
      if (!"merchantSign".equals(((String) sf.getKey()).trim())
          && !"serverSign".equals(((String) sf.getKey()).trim())
          && !"serverCert".equals(((String) sf.getKey()).trim())) {
