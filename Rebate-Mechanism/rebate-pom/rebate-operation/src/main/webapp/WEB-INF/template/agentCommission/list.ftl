...
<head>
<title>${message("rebate.agentCommission.list")}</title>
...
<body>
	<form id="listForm" action="list.jhtml" method="get">
 		<ol class="breadcrumb">
            <li><a href="#">${message("rebate.main.agentCommission")}</a></li>
            <li class="active">${message("rebate.agentCommission.list")}(${message("rebate.common.page.totalPages",page.total)})</li>
        </ol>
         ...
         <table id="listTable" class="table table-striped table-bordered">
		 		<thead>
					<tr>
						...
						<th>
							<a href="javascript:;" class="sort" name="title">${message("rebate.agentCommission.area")}</a>
						</th>
						<th>
							<a href="javascript:;" class="sort" name="commissionRate">${message("rebate.agentCommission.commissionRate")}</a>
						</th>
						<th>
				...
				<tbody>
					[#list page.content as agentCommission]
					<tr>
						<td>
							<input type="checkbox"  name="ids" value="${agentCommission.id}" />
						</td>
						<td>
							[#if  agentCommission.area??]
						...
						<td>
							${agentCommission.commissionRate}
						</td>
						<td>
							<span title="${agentCommission.createDate?string("yyyy-MM-dd HH:mm:ss")}">${agentCommission.createDate}</span>
						</td>
						<td>
							<a href="edit.jhtml?id=${agentCommission.id}" title="${message("rebate.common.edit")}"><i class="fa fa-pencil-square-o"></i></a>
						</td>
					</tr>
					[/#list]
				</tbody>
