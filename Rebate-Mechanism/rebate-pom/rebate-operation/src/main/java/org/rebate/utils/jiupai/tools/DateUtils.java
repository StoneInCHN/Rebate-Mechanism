...
public class DateUtils {
    ...
    static final String standardPtn = "yyyy-MM-dd HH:mm:ss";//����
    ...
    static final String sdf_ymdPtn = "yyyy��MM��dd��";
    ...
    public static final SimpleFastDateFormat sdf_ymd = SimpleFastDateFormat.getInstance("yyyy��MM��dd��");
    ...
    public static String getCurrDateStr(SimpleFastDateFormat format){
    	if (format == null) {
    		format = standard;
		}
